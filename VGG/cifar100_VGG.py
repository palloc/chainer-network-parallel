...
#            conv1_2=L.Convolution2D(None, 32, 3, stride=1, pad=1),
...
#            bn5=L.BatchNormalization(512),
 ...
 #           fc6=L.Linear(None, 512),
    ...
    def forward(self, x_data, y_data, train=True):
        ...
        #h = F.relu(self.model2.bn4(self.model2.conv4_1(h)))
        #h = F.dropout(h, ratio=0.3, train=train)
        #h = F.relu(self.model2.bn4(self.model2.conv4_2(h)))
        #h = F.dropout(h, ratio=0.3, train=train)
        #h = F.relu(self.model2.bn4(self.model2.conv4_3(h)))
        #h = F.max_pooling_2d(h, 2, stride=2)

        #h = F.relu(self.model2.bn5(self.model2.conv5_1(h)))
        #h = F.dropout(h, ratio=0.3, train=train)
        #h = F.relu(self.model2.bn5(self.model2.conv5_2(h)))
        #h = F.dropout(h, ratio=0.3, train=train)
        #h = F.relu(self.model2.bn5(self.model2.conv5_3(h)))
        #h = F.max_pooling_2d(h, 2, stride=2)
        
        #h = F.dropout(F.relu(self.model2.fc6(h)), train=train, ratio=0.5)
        #h = F.dropout(F.relu(self.model2.fc7(h)), train=train, ratio=0.5)
#        h = self.model2.fc7(h)
        y = self.model2.fc8(h)
